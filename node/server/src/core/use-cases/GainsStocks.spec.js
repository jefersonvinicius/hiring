...
const HistoryPrice_1 = require("../entities/HistoryPrice");
const StockNotFound_1 = require("../errors/StockNotFound");
const GainsStocks_1 = require("./GainsStocks");
describe('GainsStocksUseCase', () => {
    it('should returns the correct gains', () => __awaiter(void 0, void 0, void 0, function* () {
        const today = new Date('2021-10-20');
        jest.spyOn(Clock_1.Clock, 'now').mockReturnValue(today);
        const { sut, stockingAPISpies } = createSut();
        const purchasedAt = new Date('2021-10-06');
        const result = yield sut.execute({ purchasedAmount: 100, purchasedAt, stockName: 'any' });
    ...
    it('should throw the StockNotFound when a stock name that not exists is provided', () => __awaiter(void 0, void 0, void 0, function* () {
        const { sut, stockingAPISpies } = createSut();
        const purchasedAt = new Date('2021-10-06');
...
function createSut() {
    ...
    const sut = new GainsStocks_1.GainsStocksUseCase(stockingAPI);
